...
Package walletdb provides a namespaced database interface for eacwallet.
...
[![GoDoc](https://godoc.org/github.com/eacsuite/eacwallet/walletdb?status.png)]
(http://godoc.org/github.com/eacsuite/eacwallet/walletdb)
...
http://localhost:6060/pkg/github.com/eacsuite/eacwallet/walletdb

## Installation

```bash
$ go get github.com/eacsuite/eacwallet/walletdb
```

## Examples

* [Basic Usage Example]
  (http://godoc.org/github.com/eacsuite/eacwallet/walletdb#example-package--BasicUsage)  
