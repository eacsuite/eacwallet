...
import (
	...
	"github.com/eacsuite/eacwallet/internal/legacy/keystore"
...
const (
	defaultCAFilename       = "eacd.cert"
	defaultConfigFilename   = "eacwallet.conf"
	defaultLogLevel         = "info"
	defaultLogDirname       = "logs"
	defaultLogFilename      = "eacwallet.log"
...
var (
	btcdDefaultCAFile  = filepath.Join(eacutil.AppDataDir("eacd", false), "rpc.cert")
	defaultAppDataDir  = eacutil.AppDataDir("eacwallet", false)
...
type config struct {
	...
	TestNet4      bool                    `long:"testnet" description:"Use the test Earthcoin network (version 4) (default mainnet)"`
