...
eacwallet will not drop transaction history by itself, as this is something that
...
```
$ cd $GOPATH/src/github.com/eacsuite/eacwallet/cmd/dropwtxmgr
$ go get
```
...
```
$ dropwtxmgr
Database path: /home/username/.eacwallet/mainnet/wallet.db
Drop all eacwallet transaction history? [y/N] y
...
```
$ dropwtxmgr --db ~/.eacwallet/testnet/wallet.db
Database path: /home/username/.eacwallet/testnet/wallet.db
Drop all eacwallet transaction history? [y/N] y
Dropping wtxmgr namespace
```

After dropping transaction history, eacwallet may be restarted and a full rescan
