...
var helpDescsEnUS = map[string]string{
	...
	"getbalance--result0":    "The balance of 'account' valued in earthcoin",
	"getbalance--result1":    "The balance of all accounts valued in earthcoin",
	...
	"getreceivedbyaccount--result0":  "The total received amount valued in earthcoin",
	...
	"getreceivedbyaddress--result0":  "The total received amount valued in earthcoin",
	...
	"gettransactionresult-amount":          "The total amount this transaction credits to the wallet, valued in earthcoin",
	...
	"listaccounts--result0--desc":  "JSON object with account names as keys and earthcoin amounts as values",
	"listaccounts--result0--key":   "The account name",
	"listaccounts--result0--value": "The account balance valued in earthcoin",
	...
	"listreceivedbyaccountresult-amount":        "Total amount received by payment addresses of the account valued in earthcoin",
	...
	"listreceivedbyaddressresult-amount":            "Total amount received by the payment address valued in earthcoin",
	...
	"listtransactionsresult-amount":             "The value of the transaction output valued in earthcoin",
	...
	"listunspentresult-amount":        "The amount of the output valued in earthcoin",
	...
	"sendfrom-amount":      "Amount to send to the payment address valued in earthcoin",
	...
	"sendmany-amounts--desc":  "JSON object using payment addresses as keys and output amounts valued in earthcoin to send to each address",
	"sendmany-amounts--key":   "Address to pay",
	"sendmany-amounts--value": "Amount to send to the payment address valued in earthcoin",
	...
	"sendtoaddress-amount":    "Amount to send to the payment address valued in earthcoin",
	...
	"settxfee-amount":    "The new fee increment valued in earthcoin",
	...
	"getunconfirmedbalance--result0":  "Total amount of all unmined unspent outputs of the account valued in earthcoin.",
