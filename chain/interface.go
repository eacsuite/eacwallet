...
type Interface interface {
	...
	Rescan(*chainhash.Hash, []eacutil.Address, map[wire.OutPoint]eacutil.Address) error
	NotifyReceived([]eacutil.Address) error
	NotifyBlocks() error
...
type (
	...
	FilterBlocksRequest struct {
		...
		ExternalAddrs    map[waddrmgr.ScopedIndex]eacutil.Address
		InternalAddrs    map[waddrmgr.ScopedIndex]eacutil.Address
	...
	FilterBlocksResponse struct {
		...
		FoundOutPoints     map[wire.OutPoint]eacutil.Address
