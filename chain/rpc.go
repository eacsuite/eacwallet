...
func (c *RPCClient) Rescan(startHash *chainhash.Hash, addrs []eacutil.Address,
...
func (c *RPCClient) onRecvTx(tx *eacutil.Tx, block *btcjson.BlockDetails) {
...
func (c *RPCClient) onRedeemingTx(tx *eacutil.Tx, block *btcjson.BlockDetails) {
