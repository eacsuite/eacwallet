...
func (m *mockChainClient) Rescan(*chainhash.Hash, []eacutil.Address,
	map[wire.OutPoint]eacutil.Address) error {
	return nil
}

func (m *mockChainClient) NotifyReceived([]eacutil.Address) error {
	return nil
}
