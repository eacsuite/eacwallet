...
type RescanJob struct {
	...
	OutPoints   map[wire.OutPoint]eacutil.Address
...
// rescan.
func (w *Wallet) Rescan(addrs []eacutil.Address, unspent []wtxmgr.Credit) error {
...
func (w *Wallet) rescanWithTarget(addrs []eacutil.Address,
	unspent []wtxmgr.Credit, startStamp *waddrmgr.BlockStamp) error {

	outpoints := make(map[wire.OutPoint]eacutil.Address, len(unspent))
